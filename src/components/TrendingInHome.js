  ...
  return (
    <>
      <div className="max-w-7xl">
        <h4 className="text-3xl text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-sky-400 via-rose-400 to-lime-400 h-14 text-center mb-4 font-bold">
